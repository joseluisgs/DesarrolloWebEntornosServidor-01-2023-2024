...
public class AlumnosServiceImpl implements AlumnosService {
    ...
    private AlumnosServiceImpl(AlumnosRepository alumnosRepository) {
        ...
        this.notification = AlumnosNotificationImpl.getInstance();
    ...
    public Mono<Alumno> saveWithotNotification(Alumno alumno) {
    ...
    public Mono<Alumno> save(Alumno alumno) {
        ...
        return saveWithotNotification(alumno)
                .doOnSuccess(saved -> notification.notify(new Notificacion<>(Notificacion.Tipo.NEW, saved)));
    }


    public Mono<Alumno> updateWithoutNotification(Alumno alumno) {
    ...
    public Mono<Alumno> deleteByIdWithoutNotification(long id) {

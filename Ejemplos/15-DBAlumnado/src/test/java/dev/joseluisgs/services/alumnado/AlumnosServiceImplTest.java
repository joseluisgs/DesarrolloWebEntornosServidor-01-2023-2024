...
class AlumnosServiceImplTest {
    ...
    void findAll() throws SQLException {
        ...
        when(repository.findAll()).thenReturn(alumnos);
    ...
    @Test
    void findAllByNombre() throws SQLException {
        // Arrange
        var alumnos = List.of(Alumno.builder().nombre("Test-1").calificacion(10.0).build());

        // Cuando se llame al método al repositorio simulamos...
        when(repository.findByNombre("Test-1")).thenReturn(alumnos);
    ...
    @Test
    void save() throws SQLException, AlumnoException {
        // Arrange
        var alumno = Alumno.builder().nombre("Test-1").calificacion(10.0).build();
    ...
    @Test
    void update() throws SQLException, AlumnoException {
        // Arrange
        var alumno = Alumno.builder().nombre("Test-1").calificacion(10.0).build();

        // Cuando se llame al método al repositorio simulamos...
        when(repository.update(alumno)).thenReturn(alumno);
    ...
    @Test
    void updateNoExiste() throws SQLException, AlumnoException {
        // Arrange
    ...
    @Test
    void deleteByIdNoExiste() throws SQLException {
        // Arrange
        var alumno = Alumno.builder().nombre("Test-1").calificacion(10.0).build();
